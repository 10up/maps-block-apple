...
## [1.0.1] - 2020-08-11
### Added
- Internationalization support via loading translations for the block (props [@dinhtungdu](https://github.com/dinhtungdu) via [#69](https://github.com/10up/maps-block-apple/pull/69))
...
- Key and Team ID settings placeholders (props [@dinhtungdu](https://github.com/dinhtungdu), [@helen](https://github.com/helen) via [#57](https://github.com/10up/maps-block-apple/pull/57))
