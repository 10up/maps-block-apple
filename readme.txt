...
= 1.1.1 - 2023-06-20 =
* **Note that this release bumps the PHP minimum version from 5.6 to 7.4.**
...
* **Changed:** Bump minimum PHP version from 5.6 to 7.4 (props [@jayedul](https://github.com/jayedul), [@csloisel](https://github.com/csloisel), [@faisal-alvi](https://github.com/faisal-alvi), [@dkotter](https://github.com/dkotter) via [#133](https://github.com/10up/maps-block-apple/pull/133)).
...
* **Changed:** Bump WordPress "tested up to" version to 6.2 (props [@jayedul](https://github.com/jayedul), [@peterwilsoncc](https://github.com/peterwilsoncc), [@Sidsector9](https://github.com/Sidsector9) via [#167](https://github.com/10up/maps-block-apple/pull/167)).
* **Changed:** Update the Dependency Review GitHub Action (props [@jeffpaul](https://github.com/jeffpaul), [@Sidsector9](https://github.com/Sidsector9) via [#169](https://github.com/10up/maps-block-apple/pull/169)).
...
* Note that this version bumps the PHP minimum version from 5.6 to 7.4
